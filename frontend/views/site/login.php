                ...
                <div class="sign-in-from">
                    ...
                    <div class="d-inline-block w-100">
                        <div class="custom-control custom-checkbox d-inline-block mt-2 pt-1">
                            <?= $form->field($model, 'rememberMe')->checkbox(['itemOptions' => ['class' => 'custom-control-input']]) ?>
                        </div>
                        <?= Html::submitButton('Sign In', ['class' => 'ladda-button btn btn-primary float-right login-button', 'name' => 'signup-button', 'data-style' => "slide-right"]) ?>
                    </div>
