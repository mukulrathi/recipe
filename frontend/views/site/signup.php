...
\frontend\assets\LaddaBootstrapAsset::register($this);
        ...
        <div class="row no-gutters">
            <div class="col-md-6 text-center pt-5">
                <div class="sign-in-detail text-white">
                    <a class="sign-in-logo mb-5" href="#"><img src="/images/logo-new.png" class="img-fluid" alt="logo"></a>
            ...
            <div class="col-md-6 bg-white pt-5">
                <div class="sign-in-from">
                    ...
                    <div class="d-inline-block w-100">
                        ...
                        <?= Html::submitButton('Signup', ['class' => 'ladda-button btn btn-primary float-right signup','name' => 'signup-button', 'data-style' => "slide-right"]) ?>

                    </div>
                    <div class="sign-info">
                        <span class="dark-color d-inline-block line-height-2">Already Have Account ? <a
                                    href="<?= \yii\helpers\Url::to(['login'], true) ?>">Log In</a></span>
                    </div>
                </div>
