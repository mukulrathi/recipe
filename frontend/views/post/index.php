                    ...
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-body">
                            ...
                            <div class="user-post">
                                <div class="d-flex">
                                    <div class="col-md-6">
                                        <a href="javascript:void();"><img src="/images/page-img/p2.jpg" alt="post-/images" class="img-fluid rounded w-100"></a>
                                    </div>
                                    <div class="col-md-6 row m-0 p-0">
                                        <div class="col-sm-12">
                                            <a href="javascript:void();"><img src="/images/page-img/p1.jpg" alt="post-/images" class="img-fluid rounded w-100"></a>
                                        </div>
                                        <div class="col-sm-12 mt-3">
                                            <a href="javascript:void();"><img src="/images/page-img/p3.jpg" alt="post-/images" class="img-fluid rounded w-100"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-sm-12">
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-body">
                            <div class="user-post-data">
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="media-support-info mt-2">
                                        ...
                                        <p class="mb-0 d-inline-block">Added New /images in a Post</p>
                            ...
                            <div class="user-post">
                                <a href="javascript:void();"><img src="/images/page-img/p4.jpg" alt="post-/images" class="img-fluid rounded w-100"></a>
                            </div>
                            <div class="comment-area mt-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="like-block position-relative d-flex align-items-center">
                    ...
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-body">
                            ...
                            <div class="user-post text-center">
                                <a href="javascript:void();"><img src="/images/page-img/p5.jpg" alt="post-/images" class="img-fluid rounded w-100 mt-3"></a>
                            </div>
                            <div class="comment-area mt-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="like-block position-relative d-flex align-items-center">
                    ...
                    <div class="iq-card-body">
                        <ul class="suggested-page-story m-0 p-0 list-inline">
                            <li class="mb-3">
                                ...
                                <img src="/images/small/img-1.jpg" class="img-fluid rounded" alt="Responsive /images">
                            ...
                            <li class="">
                                ...
                                <img src="/images/small/img-2.jpg" class="img-fluid rounded" alt="Responsive /images">
                                <div class="mt-3"><a href="#" class="btn d-block"><i class="ri-thumb-up-line mr-2"></i> Like Page</a></div>
                            </li>
                        </ul>
                    </div>
